...
public class CylinderGroupConfiguration extends ShapeGroupConfiguration {
    ...
    public CylinderGroupConfiguration(List<Vector3f> sizes, List<String> appendedNames, List<Integer> numSides, List<Boolean> centered, List<Float> repeatFrequency, boolean usePlanarMapping, LoaderType loaderType) {
